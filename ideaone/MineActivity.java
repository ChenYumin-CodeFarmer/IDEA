...
public class MineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(MineActivity.this, user, Toast.LENGTH_SHORT).show();
        ...
        initIdeas();          //初始化想法数据
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_view_mine);
        ...
        SwipeRefreshLayout mSwipeLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_fresh);
        //设置在listview上下拉刷新的监听
    ...
    private static String networkRequest(String user){         //上传数据
        ...
        try {
            ...
            URL url = new URL("http://10.17.155.84:8080/servlet02/ser04");     //后台url，即servlet
