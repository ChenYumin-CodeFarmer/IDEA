...
public class SearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //在这里进行UI操作，将结果显示到界面上
        Toast.makeText(SearchResultActivity.this, SearchContent, Toast.LENGTH_SHORT).show();

        new Thread() {     //启动子线程，发送网络请求
            @Override
            public void run() {
                networkRequest(SearchContent);
            }
        }.start();
        ...
        SwipeRefreshLayout mSwipeLayout = (SwipeRefreshLayout) findViewById(R.id.search_fresh);
        //设置在listview上下拉刷新的监听 智能
    ...
    private static String networkRequest(String Search){         //上传数据
        HttpURLConnection connection=null;
        String rs = null;
        try {
            //  URL url = new URL("http://192.168.43.167:8080/servlet02/ser02");
            URL url = new URL("http://10.17.155.84:8080/servlet02/ser09");     //后台url，即servlet
            ...
            String param="SearchContent="+Search;               //上传用户名
